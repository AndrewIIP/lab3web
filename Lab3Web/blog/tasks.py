...
from Lab3Web.celery import app  # app is your celery application
from Lab3Web.settings import EMAIL_HOST_USER
from . import models as M

hostname = "127.0.0.1:8000"


# celery -A  Lab3Web worker -n A -l INFO --concurrency 1 -P solo -Q big_tasks
# celery -A  Lab3Web worker -n B -l INFO --concurrency 1 -P solo -Q messages
# celery -A Lab3Web flower
